...
<div class="container">
    ...
    <div id="Categoria">
        ...
        <select class="form-control col-5" id="produto">
            <option value="op">-</option>
            <option value="op">Destilados</option>
            <option value="op">Vinhos</option>
            <option value="op">Refrigerantes</option>
            <option value="op">Sucos</option>
        </select>
        <button onclick="filtraPorProduto()" type="submit" class="btn btn-primary">&#128269;</button>
    </div>
    <div id="Cliente">
        <div class="input-group mb-3">
            <p><input type="search" id="campoCpf" name="cpf_cliente" size="15" placeholder="000.000.000-00" value=""
