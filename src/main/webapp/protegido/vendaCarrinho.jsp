            ...
            <div class="card-body">
                <form action="VendaProduto" method="GET">
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">CÛdigo do Produto</label>
                        <div class="col-sm-10">
                            <input name="codProduto" placeholder="CÔøΩdigo do Produto" class="form-control" />
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" id="qtdVendida" name="qtdVendida" value="0"
                            onfocus="calcularSubTotal()" required="required" />
                        <input type="hidden" id="preco" name="preco" value="${produto.preco}"
                            onblur="calcularSubTotal()" />
                    </div>
                </div>
                <div class="form-group row">
                ...
                <button type="button" class="btn btn-primary"
                    onclick="adicionarProdutoNaSessao(${produto.cod_produto})">Adicionar no carrinho</button>
            </div>
        </div>
        <br>
        <div class="card w-50">
                        ...
                        <tbody>
                            <c:forEach var="p" items="${listaProdutos}">
                                <tr>
                                    ...
                                    <td><a><img onclick="excluirProdutoCarrinho(${p.cod_produto})"
                                                src="imagens/icon_excluir.png" alt="Excluir"></a></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
